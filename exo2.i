...
# 27 "exo2/exo2.c"
    ...
    int arrayLength = getArgumentValueInt(1, argv[1]);
    int numberOfThreads = getArgumentValueInt(2, argv[2]);
...
void test2(float *array, int length)
{
    ...
    for (int i = 0; i < length; i++)
        array[i] = (2.17f * logf(array[i]) * cosf(array[i]));
